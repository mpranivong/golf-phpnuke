	...
	function main_ban($ip=0) {
		...
		if ($numrows != 0) {
			...
			while ($row = $db->sql_fetchrow($result)) {
				...
				."<td bgcolor=\"$bgcolor2\" align='center'>&nbsp;<a href=\"".$admin_file.".php?op=ipban_edit&id=$row[id]\"><img src=\"images/edit.gif\" alt=\""._EDIT."\" title=\""._EDIT."\" border=\"0\" width=\"17\" height=\"17\"></a>&nbsp;<a href=\"".$admin_file.".php?op=ipban_delete&id=$row[id]&ok=0\"><img src=\"images/unban.gif\" width=\"15\" height=\"15\" border=\"0\" alt=\""._UNBAN."\" title=\""._UNBAN."\"></a>&nbsp;</td></tr>";
			}
			echo "</table>";
			CloseTable();
		}
