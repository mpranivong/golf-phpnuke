...
if (!$no_header) {
	echo "<br><center><table border=\"0\" width=\"". DFWLGA_MAX_WIDTH . "\" cellpadding=\"0\" cellspacing=\"0\"><tr><td colspan='3' align='center' height='159' width='800'>";
	//echo "<a href=$nukeurl><img src='themes/$ThemeSel/images/logo.gif' Alt=\""._WELCOMETO." $sitename\" border='0'></a>";
	//echo "<a href=http://www.dfwlga.com><img src='themes/$ThemeSel/images/logo_right.gif' Alt=\"DFW Lao Golf\" border='0'></a>";
	echo "<a href=$nukeurl><img src='themes/$ThemeSel/images/header.gif' Alt=\""._WELCOMETO." $sitename\" border='0'></a>";
	echo "</td>\n";
/*
if ($banners) {
echo "<td>";
...
echo "</td>";
	...
	echo "</tr><!--tr><td width='29' height='33'>&nbsp;</td><td width='472' height='33'>&nbsp;</td>";
	echo "<td align='left' width='238' height='33'>";
	echo "<img src='themes/$ThemeSel/images/header_8.jpg' width='238' height='33'></img>";

	echo "</td></tr-->";
	echo '</tr><tr><td colspan="3" background="themes/$ThemeSel/images/separator_2.jpg" width="800" height="3"></td>';
	echo "</table>";

	//"\n<br>\n";
	//$public_msg = public_message();
	//echo "$public_msg<br>";
	echo "<table width=\"".DFWLGA_MAX_WIDTH."\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\"><tr>";
	if (!is_forum_page()) {
		//echo "<td valign='top' background='themes/$ThemeSel/images/separator_1.jpg' width='7' height='3'></td>";
		echo "<td valign=\"top\" width=\"".DFWLGA_LEFTCOL_WIDTH."\">\n";
	
		blocks(left);
		//echo "</td><td background='themes/$ThemeSel/images/separator_2.jpg' width='8' height='3'></td>";
	}
	$width = get_center_width();
}
...
function themesidebox($title, $content, $width=DFWLGA_RIGHTCOL_WIDTH, $bgcolor="#CCFFCC", $side='l') {
    $ThemeSel = get_theme();
    mt_srand((double)microtime()*1000000);
    $rcolor = mt_rand(1, 3);
    if ($side == 'l') {
